...
<head>
    ...
    <script>
        ...
        function displayTeachers(teachers) {
            ...
            teachers.forEach(function(teacher) {
                tbody.append(
                    ...
                    '<td>' + teacher.email + '</td>' +
                    '<td>' +
                    '<button class="button bg-blue" onclick="editTeacher(' + teacher.tid + ')" style="margin-right: 5px;">' +
        ...
        function editTeacher(tid) {
            location.href = 'editTeacher.jsp?tid=' + tid;
        }
    </script>
</head>
<body>
    <div class="panel">
        <div class="panel-head">
            ...
            <button class="button bg-green" onclick="location.href='addTeacher.jsp'" style="float: right; margin-right: 10px;">
